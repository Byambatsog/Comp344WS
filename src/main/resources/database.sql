...
-- -----------------------------------------------------
-- Table `comp344_ecommerce`.`customer_carts`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `comp344_ecommerce`.`customer_carts` ;

CREATE TABLE IF NOT EXISTS `comp344_ecommerce`.`customer_carts` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `created_at` DATETIME NULL,
  `customers_id` INT NOT NULL,
  PRIMARY KEY (`id`))
...
CREATE TABLE IF NOT EXISTS `comp344_ecommerce`.`customer_cart_items` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `quantity` INT(11) NULL,
  `customer_carts_id` INT NOT NULL,
  `products_id` INT NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
